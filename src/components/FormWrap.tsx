      ...
      <div className="form-section__form">
        ...
        <form method="POST" action="#">
          <div className="form-input__initials">
            ...
            <input className="form-input__lastName" type="lastName" name="lastName" placeholder="Last name" maxLength={20} />
          </div>
          <input type="email" name="email" placeholder="Email" className="form-input__email" maxLength={20} />
          <input type="phone" name="phone" placeholder="Cell phone number" className="form-input__phone" maxLength={20} />
          <textarea name="message" placeholder="WHAT`S YOUR QUESTION, COMMENT OR ISUUE?" className="form-input__textarea" maxLength={60} />
